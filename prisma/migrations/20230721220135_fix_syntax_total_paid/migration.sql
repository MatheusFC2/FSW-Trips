/*
  ...
  - You are about to drop the column `totalpaid` on the `TripReservation` table. All the data in the column will be lost.
...
*/
-- AlterTable
ALTER TABLE "TripReservation" DROP COLUMN "totalpaid",
